...
//Friendzone:
    ...
    friend double computeInnerProduct( const PersistenceLandscape& l1 , const PersistenceLandscape& l2 );
...
PersistenceLandscape::PersistenceLandscape(char* filename)
{
    ...
    {
		std::cout << "The file : " << filename << " do not exist. The program will now terminate \n";
...
double computeInnerProduct( const PersistenceLandscape& l1 , const PersistenceLandscape& l2 )
{
    ...
    {
        if ( dbg ){cerr << "Compute inner product in the level : " << level << endl;getchar();}
        ...
        while ( ( l1It <= l1.land[level].size()-2 ) && ( l2It <= l2.land[level].size()-2 ) )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    x2 = std::min( l1.land[level][l1It+1].first , l2.land[level][l2It+1].first );
                }
            }
